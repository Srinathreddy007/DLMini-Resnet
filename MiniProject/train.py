...
class Train:
    ...
    def run(
        ...
        for epoch in tqdm(range(epochs)):
            ...
            val_acc, val_loss = self.test(epoch, model, device, criterion, testloader)
            scheduler.step()
        ...
        plot = Plotter()
        plot.plot_train_loss(train_loss_history, range(epochs))
        plot.plot_train_accuracy(train_acc_history, range(epochs))
        plot.plot_loss_comparison(train_loss_history, val_loss_history, range(epochs))
        plot.plot_accuracy_comparison(train_acc_history, val_acc_history, range(epochs))